...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/NiLphreakz/betatest/main/add-user/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/NiLphreakz/betatest/main/delete-user/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/NiLphreakz/betatest/main/cek-user/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/NiLphreakz/betatest/main/renew-user/renew-ss.sh"
wget -O ssssr "https://raw.githubusercontent.com/NiLphreakz/betatest/main/menu/ssssr.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
